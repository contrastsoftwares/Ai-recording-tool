...
const es: Translations = {
  ...
  photoSolver: {
    title: "Resolver Foto",
    subtitle: "Toma una foto o sube imágenes de cualquier problema y obtén soluciones paso a paso",
    takeOrUpload: "Toma una foto o sube imágenes",
    ofAnyProblem: "de cualquier problema de matemáticas, ciencias o académico",
    uploadImage: "Subir Imagen",
    uploadImages: "Subir Imágenes",
    uploadUpTo: "Sube hasta 20 imágenes por sesión",
    ...
    solveNow: "Resolver",
    readyToSolve: "Listo para resolver",
    clickSolve: "Haz clic en Resolver para analizar tus imágenes",
  },
  audioRecorder: {
...
const fr: Translations = {
  ...
  photoSolver: {
    ...
    subtitle: "Prenez une photo ou téléchargez des images de n'importe quel problème et obtenez des solutions étape par étape",
    takeOrUpload: "Prenez une photo ou téléchargez des images",
    ...
    uploadUpTo: "Téléchargez jusqu'à 20 images par session",
    ...
    imagesLabel: "images",
    solveNow: "Résoudre",
    readyToSolve: "Prêt à résoudre",
    clickSolve: "Cliquez sur Résoudre pour analyser vos images",
  },
  audioRecorder: {
...
const de: Translations = {
  ...
  photoSolver: {
    title: "Foto-Löser",
    subtitle: "Mach ein Foto oder lade Bilder von einem Problem hoch und erhalte schrittweise Lösungen",
    takeOrUpload: "Mach ein Foto oder lade Bilder hoch",
    ofAnyProblem: "von jedem Mathe-, Naturwissenschafts- oder akademischen Problem",
    uploadImage: "Bild Hochladen",
    uploadImages: "Bilder Hochladen",
    uploadUpTo: "Lade bis zu 20 Bilder pro Sitzung hoch",
    ...
    imagesLabel: "Bilder",
    solveNow: "Lösen",
    readyToSolve: "Bereit zum Lösen",
    clickSolve: "Klicke auf Lösen, um deine Bilder zu analysieren",
  },
  audioRecorder: {
    title: "Audiorekorder",
...
const zh: Translations = {
  ...
  photoSolver: {
    title: "拍照解题",
    subtitle: "拍照或上传任何问题的图片，获取逐步解答",
    takeOrUpload: "拍照或上传图片",
    ofAnyProblem: "任何数学、科学或学术问题",
    uploadImage: "上传图片",
    uploadImages: "上传图片",
    uploadUpTo: "每次最多上传20张图片",
    takePhoto: "拍照",
...
const ja: Translations = {
  ...
  photoSolver: {
    ...
    uploadUpTo: "1セッションにつき最大20枚の画像をアップロード可能",
    takePhoto: "写真を撮る",
    ...
    imagesLabel: "枚の画像",
    solveNow: "解く",
    readyToSolve: "解く準備ができました",
    clickSolve: "解くをクリックして画像を分析",
  },
  audioRecorder: {
    title: "音声レコーダー",
...
const ko: Translations = {
  ...
  photoSolver: {
    ...
    uploadUpTo: "세션당 최대 20개의 이미지를 업로드할 수 있습니다",
    takePhoto: "사진 촬영",
    ...
    imagesLabel: "개 이미지",
    solveNow: "풀기",
    readyToSolve: "풀이 준비 완료",
    clickSolve: "풀기를 클릭하여 이미지를 분석하세요",
  },
  audioRecorder: {
    title: "오디오 녹음기",
